...
namespace AFramework
{
    ...
    public static class IEnumerableExtension
    {
        ...
        public static void RemoveValue<K, V>(this Dictionary<K, V> dict, K key)
        {
        ...
        public static void AddValue<K, V>(this Dictionary<K, V> dict, K key, V value, bool isOverride = false)
        {
            if (dict.ContainsKey(key))
            {
                if (isOverride)
        ...
        public static void AddValue<K, V, T>(this Dictionary<K, V> dict, K key, T value, bool isAdd = false) where V : class
        {
            if (dict.ContainsKey(key))
            {
                if (isAdd)
                {
                    ...
                    {
                        vt = dict[key] as List<T>;
                    }
                    if (!vt.Contains(value))
                        vt.Add(value);
                    dict[key] = vt as V;
                }
            }
            ...
            {
                List<T> vt = new List<T>();
                vt.Add(value);
                dict.Add(key, vt as V);
            }
        }
        #endregion
    }
    ...
    public static class ReflectionExtension
    {
        public static Assembly GetAssemblyCSharp()
        {
            ...
            AFLogger.e(">>>>>>>Error: Can\'t find Assembly-CSharp.dll");
            return null;
        }
        ...
        public static Assembly GetAssemblyCSharpEditor()
        {
            ...
            AFLogger.e(">>>>>>>Error: Can\'t find Assembly-CSharp-Editor.dll");
            return null;
        }
