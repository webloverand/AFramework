...
public class MediaController : MonoBehaviour {
	...
	private void SetGalleryPath()
	{
		...
		{
			AndroidJavaClass androidJavaClass = new AndroidJavaClass("com.Wili.ImageSaver.MediaController");
	...
	public static void SaveImageToGallery(Texture2D qrCode)
	{
		...
		if (Application.platform == RuntimePlatform.Android) {
			MediaController mediactr = UnityEngine.Object.FindObjectOfType<MediaController> ();
			if (mediactr != null) {
